...
module.exports = {
      ...
      lumine.commands.add(this.selectList.element, {
        ...
        "fuzzy-explorer:use-default-separator": {
          ...
          didDispatch: () => {
            ...
            lumine.notifications.addSuccess("Separator has been changed to default");
          },
        },
        "fuzzy-explorer:use-forward-slashes": {
          ...
          didDispatch: () => {
            ...
            lumine.notifications.addSuccess("Separator has been changed to forward slash");
          },
        },
        "fuzzy-explorer:use-backslashes": {
          ...
          didDispatch: () => {
            ...
            lumine.notifications.addSuccess("Separator has been changed to backslash");
          },
        },
  ...
  observeCacheUpdates() {
    this.cacheUpdateSubscription.dispose();
    this.cacheUpdateSubscription = lumine.applicationDelegate.onDidReceiveWindowEvent(
  ...
  notifyCacheUpdate() {
    lumine.applicationDelegate.emitToOtherWindows(CACHE_UPDATED_CHANNEL, this.cacheFingerprint);
  },
  ...
  performAction(mode, params) {
    ...
    if (mode === "open") {
      ...
      if (!this.claudeChatService) {
        lumine.notifications.addWarning("claude-chat service not available");
        return;
      }
      const [, relativePath] = lumine.project.relativizePath(item);
      const context = {
        type: "paths",
        paths: [item],
